...
python3 -c "import zipfile, os; z = zipfile.ZipFile(\"tak/certs/files/$USER-$IP.dp.zip\", \"w\"); z.write(\"manifest.xml\", \"manifest.xml\"); z.write(\"server.pref\", \"certs/server.pref\"); z.write(\"tak/certs/files/$IP.p12\", \"certs/$IP.p12\"); z.write(\"tak/certs/files/$USER.p12\", \"certs/$USER.p12\"); z.close()"
echo "-------------------------------------------------------------"
